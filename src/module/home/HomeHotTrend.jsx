      ...
      <div className="product-list">
        ...
        {/* <SwiperSlide>
            <div className="p-5  product-item overflow-hidden  hover:opacity-90 bg-white text-white rounded-lg flex flex-col h-full relative ">
              ...
              <img
                src="../images/x1.jpg.pagespeed.ic.blIP8y34U6.webp"
                alt=""
                className="h-[163px] w-[163px] object-cover mb-5 rounded-lg"
              />
              <div className="flex flex-col flex-1">
          ...
          <SwiperSlide>
            <div className="p-5  product-item overflow-hidden  hover:opacity-90 bg-white text-white rounded-lg flex flex-col h-full relative ">
              ...
              <img
                src="../images/x3_1.jpg.pagespeed.ic.050sfzr76-.jpeg"
                alt=""
                className="h-[163px] w-[163px] object-cover mb-5 rounded-lg"
              />
              <div className="flex flex-col flex-1">
          ...
          <SwiperSlide>
            <div className="p-5  product-item overflow-hidden  hover:opacity-90 bg-white text-white rounded-lg flex flex-col h-full relative ">
              ...
              <img
                src="../images/x9_1.jpg.pagespeed.ic.15Vhbr4Sus.webp"
                alt=""
                className="h-[163px] w-[163px] object-cover mb-5 rounded-lg"
              />
              <div className="flex flex-col flex-1">
          ...
          <SwiperSlide>
            <div className="p-5  product-item overflow-hidden  hover:opacity-90 bg-white text-white rounded-lg flex flex-col h-full relative ">
              ...
              <img
                src="../images/x33-1.jpg.pagespeed.ic.5-UDyWjPTA.webp"
                alt=""
                className="h-[163px] w-[163px] object-cover mb-5 rounded-lg"
              />
              <div className="flex flex-col flex-1">
